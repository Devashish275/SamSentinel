...
export const MOCK_CART_ITEMS: CartItem[] = [
  {
    ...
    quantity: 2,
    total: +(MOCK_PRODUCTS[0].price * 2).toFixed(2),
  },
  {
    product: MOCK_PRODUCTS[1],
    quantity: 1,
    total: +(MOCK_PRODUCTS[1].price * 1).toFixed(2),
  },
  {
    product: MOCK_PRODUCTS[2],
    quantity: 1,
    total: +(MOCK_PRODUCTS[2].price * 1).toFixed(2),
  },
  {
    product: MOCK_PRODUCTS[4],
    quantity: 1,
    total: +(MOCK_PRODUCTS[4].price * 1).toFixed(2),
  },
];
