...
import { MOCK_CART_ITEMS, MOCK_OFFERS } from '../constants/mockData';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          ...
          <Text style={[styles.offersButtonText, showOffers && styles.offersButtonTextActive]}>
            Offers
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.cameraSection}>
        <View style={styles.cameraPlaceholder}>
          ...
          <Text style={styles.cameraSubtext}>Products will be detected here</Text>
        </View>
      </View>
